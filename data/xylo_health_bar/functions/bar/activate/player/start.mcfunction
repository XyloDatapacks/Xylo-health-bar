...
summon minecraft:text_display ~ ~ ~ {Tags:["smithed.entity","smithed.strict","xhb.health_bar","xhb.health_bar_new","xhb.health_bar.player"],teleport_duration:1,text:'{"text":""}',billboard:"center",default_background:0b,background:0,CustomName:'{"text":"xylo_health_bar"}',Passengers:[{id:"minecraft:area_effect_cloud",Duration:100000,Tags:["smithed.entity","smithed.strict","xhb.health_bar","xhb.health_bar.player"],CustomName:'{"text":"xylo_health_bar.origin_get"}'}]}
